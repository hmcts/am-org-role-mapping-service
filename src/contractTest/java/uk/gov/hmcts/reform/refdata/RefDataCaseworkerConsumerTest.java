...
@PactFolder("pacts")
@PactTestFor(providerName = "referenceData_caseworkerRefUsers", port = "8991", pactVersion = PactSpecVersion.V2)
...
public class RefDataCaseworkerConsumerTest {
    ...
    @Test
    @PactTestFor(pactMethod = "generatePactFragment", pactVersion = PactSpecVersion.V2)
    ...
    @Test
    @PactTestFor(pactMethod = "getCaseworkersByServiceNamePact", pactVersion = PactSpecVersion.V2)
