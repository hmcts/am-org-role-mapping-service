...
public class RefDataCaseworkerConsumerTest {
    ...
    @Test
    @PactTestFor(pactMethod = "generatePactFragment", pactVersion = PactSpecVersion.V1)
    ...
    @Test
    @PactTestFor(pactMethod = "getCaseworkersByServiceNamePact", pactVersion = PactSpecVersion.V1)
