...
@PactFolder("pacts")
@PactTestFor(providerName = "referenceData_judicialv2", port = "8991", pactVersion = PactSpecVersion.V1)
...
public class RefDataJudicialProfileConsumerTestV2 {
    ...
    @Test
    @PactTestFor(pactMethod = "getJrdProfilesListOfIds", pactVersion = PactSpecVersion.V1)
    ...
    @Test
    @PactTestFor(pactMethod = "getJrdProfilesServiceName", pactVersion = PactSpecVersion.V1)
