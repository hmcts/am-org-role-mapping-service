...
@PactFolder("pacts")
@PactTestFor(providerName = "referenceData_judicialv2", port = "8991", pactVersion = PactSpecVersion.V2)
...
public class RefDataJudicialProfileConsumerTestV2 {
    ...
    @Test
    @PactTestFor(pactMethod = "getJrdProfilesListOfIds", pactVersion = PactSpecVersion.V2)
    ...
    @Test
    @PactTestFor(pactMethod = "getJrdProfilesServiceName", pactVersion = PactSpecVersion.V2)
