...
@PactTestFor(providerName = "am_judicialBooking_create", pactVersion = PactSpecVersion.V1_1)
@PactFolder("pacts")
...
public class JudicialBookingCreateConsumerTest {
    ...
    @Test
    @PactTestFor(pactMethod = "executeCreateJudicialBooking", pactVersion = PactSpecVersion.V1_1)
