...
@PactTestFor(providerName = "am_judicialBooking_create", pactVersion = PactSpecVersion.V4)
@PactFolder("pacts")
...
public class JudicialBookingCreateConsumerTest {
    ...
    @Test
    @PactTestFor(pactMethod = "executeCreateJudicialBooking", pactVersion = PactSpecVersion.V4)
