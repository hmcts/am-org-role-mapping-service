...
@PactTestFor(providerName = "am_roleAssignment_deleteAssignment", pactVersion = PactSpecVersion.V1_1)
@PactFolder("pacts")
...
public class OrgRoleMappingConsumerTestForDelete extends BaseTestContract {
    ...
    @Test
    @PactTestFor(pactMethod = "executeDeleteActorByPrAndGet204", pactVersion = PactSpecVersion.V1_1)
    ...
    @Test
    @PactTestFor(pactMethod = "executeDeleteActorByIdAndGet204", pactVersion = PactSpecVersion.V1_1)
