...
@PactTestFor(providerName = "am_roleAssignment_queryAssignment", pactVersion = PactSpecVersion.V4)
@PactFolder("pacts")
...
public class OrgRoleMappingConsumerTestForSearchQuery extends BaseTestContract {
    ...
    @Test
    @PactTestFor(pactMethod = "executeAdvancedSearchQueryRoleAssignmentAndGet200", pactVersion = PactSpecVersion.V4)
    ...
    @Test
    @PactTestFor(pactMethod = "executeSearchQueryRoleAssignmentAndGet200", pactVersion = PactSpecVersion.V4)
    ...
    @Test
    @PactTestFor(pactMethod = "executeSearchQueryRoleAssignmentByRoleNameAndGet200", pactVersion = PactSpecVersion.V4)
    ...
    @Test
    @PactTestFor(pactMethod = "executeSearchQueryRoleAssignmentByAttributesAndGet200", pactVersion = PactSpecVersion.V4)
