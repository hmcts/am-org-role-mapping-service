...
Feature: F-008 : Create Role Assignments for PrivateLaw Caseworker and Judicial Users
  ...
  @S-073
  @FeatureToggle(DB:privatelaw_wa_1_8=on) @FeatureToggle(EV:JUDICIAL_FTA_ENABLED=on)
  ...
  @S-074
  @FeatureToggle(DB:privatelaw_wa_1_7=on) @FeatureToggle(EV:JUDICIAL_FTA_ENABLED=on)
  ...
  @S-075
  @FeatureToggle(DB:privatelaw_wa_1_9=on) @FeatureToggle(EV:JUDICIAL_FTA_ENABLED=on)
