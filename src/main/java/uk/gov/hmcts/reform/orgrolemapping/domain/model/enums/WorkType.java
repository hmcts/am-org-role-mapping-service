...
public enum WorkType {
    ...
    CONTESTED_APPLICATIONS("contested_applications"),
    CONTESTED_EVIDENCE("contested_evidence"),
    CONTESTED_HEARING_WORK("contested_hearing_work"),
    CONTESTED_POST_HEARING("contested_post_hearing"),
    CONTESTED_PRE_HEARING("contested_pre_hearing"),
    CONTESTED_ROUTINE_WORK("contested_routine_work"),
    BAIL_WORK("bail_work"),
