...
public class RequestMappingService<T> {
    ...
    public static final String PROFESSIONAL_ORGANISATIONAL_ROLE_MAPPING = "professional-organisational-role-mapping";
    ...
    ResponseEntity<Object> updateProfileRoleAssignments(String userId, Collection<RoleAssignment> roleAssignments,
        ...
        log.debug("Role Assignment Service response status is {} for the userId {}", requireNonNull(responseEntity)
