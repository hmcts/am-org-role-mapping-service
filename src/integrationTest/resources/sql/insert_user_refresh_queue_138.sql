...
VALUES(1, now(), now(), 1, null, '[{ "jurisdictionId": "BEFTA_JURISDICTION_1","organisationProfileId": "SOLICITOR_PROFILE","accessTypeId": "1","enabled": true} ,{ "jurisdictionId": "BEFTA_JURISDICTION_2","organisationProfileId": "SOLICITOR_PROFILE","accessTypeId": "2","enabled": true}]'::jsonb, 'OrgId', 'OrgStatus', '{"SOLICITOR_PROFILE","2"}', true);
