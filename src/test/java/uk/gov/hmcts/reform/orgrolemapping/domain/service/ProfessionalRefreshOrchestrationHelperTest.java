...
class ProfessionalRefreshOrchestrationHelperTest {
    ...
    @Test
    void shouldProcessActiveUserRefreshQueueWithGroupAccess() throws IOException {
        AccessTypesEntity accessTypesEntity = AccessTypesEntity.builder()
                .version(1L)
                .accessTypes(getAccessTypes(true))
                .build();
    ...
    @Test
    void shouldProcessActiveUserRefreshQueueWithoutGroupAccess() throws IOException {
        AccessTypesEntity accessTypesEntity = AccessTypesEntity.builder()
                .version(1L)
                .accessTypes(getAccessTypes(false))
                .build();
    ...
    private String getAccessTypes(boolean groupAccessEnabled) {
